...
- **`config.yaml`**: The model configuration file. It provides the setup definitions mapping directly into LiteLLM, outlining API keys, URLs, and model strings for various AI agents (like Grok, Gemini, and locally run Ollama models).
