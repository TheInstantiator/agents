...
class MyStockPicker():
    ...
    def __init__(self, llm_overrides=None):
        ...
        Args:
            llm_overrides: Dict to override which LLM each agent/role uses.
                          Useful for fallback scenarios or getting diverse opinions.
                          ...
                          - manager: gemini (fast coordinator)
                          - researcher: grok (thorough research)
                          - analyst: gemini (quick analysis)
                          - rater: grok (different perspective)
        """
