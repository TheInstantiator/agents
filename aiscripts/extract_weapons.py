...
OUTPUT_PATH = "/home/ouar/projects/agents/aiscripts/weapons_table_snippet.md"

print(f"Converting PDF to markdown...")
md_text = pymupdf4llm.to_markdown(DOC_PATH)

start_idx = md_text.find("## Weapons")
if start_idx != -1:
    snippet = md_text[start_idx:start_idx + 10000]
    with open(OUTPUT_PATH, "w") as f:
        f.write(snippet)
    print(f"Saved snippet to {OUTPUT_PATH}")
else:
    print("Weapons section not found.")
